...
class _ResourceCapturer(threading.Thread):
    ...
    '''
    def __init__(self, deviceId, pkgName, resultPath):
    ...
    def run(self):
        ...
        outPath = os.path.join(self._resultPath, self._deviceId)
        ...
        fp_cpu.write("DateTime\tCPU%%\tVSS\tRSS\r\n")
...
class Tester(object):
    ...
    def setOutputPath(self, resultPath):
        self._resultPath = resultPath
        return self
    ...
    def doRun(self):
        ...
        class Runner(threading.Thread):
            ...
            def run(self):
                ...
                capturer = _ResourceCapturer(parent._deviceId, parent._targetPkg, parent._resultPath)
